package com.example.alarma3botones;
...
import com.example.alarma3botones.R;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void sendNotification() {
        ...
        NotificationCompat.Builder notifyBuilder = new NotificationCompat.Builder(this)
                ...
                .addAction(R.drawable.avion,getString(R.string.learn_more),
                        learnMorePendingIntent)
                .addAction(R.drawable.humo,getString(R.string.update),updatePendingIntent)
    ...
    private void updateNotification() {
        ...
        Bitmap androidImage = BitmapFactory.decodeResource(getResources(),R.drawable.humo);
        ...
        NotificationCompat.Builder notifyBuilder = new NotificationCompat.Builder(this)
                ...
                .setDefaults(NotificationCompat.DEFAULT_ALL)
                .setDeleteIntent(cancelPendingIntent)
                .addAction(R.drawable.despachadora, getString(R.string.learn_more),
                        learnMorePendingIntent)
